...
export default function ViewContact({ selectedContact, setSingleView, users, getAllcontacts }) {
		...
		<Box display="flex" flexDirection="column" height="500px">
			...
			<Box
				...
				<Box className="main-header">
					<Box className="header-in">
						<Box sx={{ display: 'flex', width: '100%', paddingLeft: '15px' }}>
							...
							<Box sx={{ width: '60%', height: '100%', display: 'flex', flexDirection: 'column' }}>
								...
								<span style={{ color: 'blue' }}>{selectedContact.contact_owner.username}</span>
							</Box>
						</Box>
					</Box>
					<Box className="header-in">
					...
					<Box className="header-in">
						<label>
							Created on<span style={{ color: 'red' }}>*</span>
						</label>
				...
				<Box className="metsec-one">
					...
					<Box className="header-in">
						<label>
							Life Cycle Stage<span style={{ color: 'red' }}>*</span>
						</label>
				...
				<Box className="metsec-two">
					<Box sx={{ widht: '100%', height: '30px' }}>
						<p
							className="only-font"
							style={{ paddingLeft: '15px', fontWeight: '500', fontSize: '16px' }}>
							Activity
						</p>
					</Box>
