			...
			{!otpPage ? (
				<Container
					...
					<Box sx={{ height: '20%', width: '100%' }}>
						<Box sx={{ display: 'flex', alignItems: 'center ', height: '100%', color: '#2b3749' }}>
							<span style={{ fontWeight: '600', fontSize: '18px', cursor: 'pointer' }}>
				...
				<OTP setOtpPage={setOtpPage} personalData={personalData} companyData={companyData}/>
			)}
		</Box>
	);
}
