...
function EditMeeting({ selectedMeeting, setOpenPopup, getMeetings, setSingleView }) {
	...
	const [type, setType] = useState({ value: selectedMeeting.type, value: selectedMeeting.type });
				...
				<Grid container sx={{ width: '70%' }}>
					<Grid item sm={6}>
						<Box className="input-label-box" sx={{ marginBottom: '10px' }}>
							<InputLabel className="label-stl" size="small" variant="filled" required>
								Meeting Name
							</InputLabel>
						</Box>
					</Grid>
					...
					<Grid item sm={6}>
						<Box className="input-input-box">
							<Select
								...
								defaultValue={[{ value: selectedMeeting.type, value: selectedMeeting.type }]}
								onChange={selectType}
								options={types}
								name="contactOwner"></Select>
						</Box>
					</Grid>
					<Grid item sm={6}>
						<Box className="input-label-box">
					...
					<Grid item sm={6}>
						<Box className="input-input-box" sx={{ width: '500px', paddingTop: '20px' }}></Box>
					</Grid>
					<Grid item sm={6}>
						<Box
							className="input-input-box "
