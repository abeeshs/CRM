...
export const userDataValidate = async (data) => {
	try {
		const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/signup-validate`, data);
		return res.data;
	} catch(error) {
		const message =
...
export const sendEmailOtp = async (data) => {
	try {
		const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/signup/sent-otp`, data);
		return res.data;
	} catch(error) {
		const message =
			(error.response && error.response.data && error.response.data.message) ||
...
export const varifySignUpOtp = async (data) => {
	...
	try {
		const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/signup/verify-otp`, data);
		return res.data;
	} catch(error) {
		const message =
			(error.response && error.response.data && error.response.data.message) ||
